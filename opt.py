...
def get_args():
    ...
    parser.add_argument('--train-path', type=str, default='/scratch/Lenslet_8x8_RGB/',  help='Direcory with training pngs in ODP format')
    parser.add_argument('--val-path', type=str, default='/scratch/Lenslet_8x8_Validation/',  help='Direcory with validation pngs in ODP format')
    parser.add_argument('--test-path', type=str, default='/scratch/Lenslet_8x8_Validation/',  help='Direcory with test pngs in ODP format')
    ...
    parser.add_argument('--run-name', default='delete', type=str)
