...
def get_args():
    ...
    #Training parametes
    parser.add_argument('--train-path', type=str, default='/scratch/dataset/JPG-AROD_grayscale/',  help='Direcory with training pngs in ODP format')
    ...
    parser.add_argument('--val-path', type=str, default='/scratch/dataset/JPG-AROD_grayscale/',  help='Direcory with validation pngs in ODP format')
    parser.add_argument('--test-path', type=str, default='/scratch/dataset/jvet_1stframe/png/',  help='Direcory with test pngs in ODP format')
